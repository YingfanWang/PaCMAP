...
def test_transform_tree_2_splits(mnist_data):
    ...
    X_train, X_test, embeddings = setup_transform_test(mnist_data, 2, save_index=True)
...
def test_transform_tree_5_splits(mnist_data):
    ...
    X_train, X_test, embeddings = setup_transform_test(mnist_data, 5, save_index=True)
    [embedding, embedding_extra, embedding_combined] = embeddings
...
def test_transform_tree_10_splits(mnist_data):
    ...
    X_train, X_test, embeddings = setup_transform_test(mnist_data, 10, save_index=True)
    [embedding, embedding_extra, embedding_combined] = embeddings
